...
register(
    id='StarTrader-v0',
    entry_point='baselines.my_gym.StarTrader:StarTradingEnv',
)

register(
    id='StarTraderTest-v0',
    entry_point='baselines.my_gym.StarTraderTest:StarTradingTestEnv',
)
...
def train(args, extra_args):
    ...
    print('1 Training {} on {}:{} with arguments \n{}'.format(args.alg, env_type, env_id, extra_args))
    ...
    print('2 Training {} on {}:{} with arguments \n{}'.format(args.alg, env_type, env_id, extra_args))
    env = build_env(args)
    print('3 Training {} on {}:{} with arguments \n{}'.format(args.alg, env_type, env_id, extra_args))
